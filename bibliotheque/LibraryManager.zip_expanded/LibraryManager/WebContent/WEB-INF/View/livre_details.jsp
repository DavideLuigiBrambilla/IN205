	      ...
	      <form action="livre_details?id=${livre.getId()}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        ...
	        <div class="row">
	          <div class="input-field col s6">
	            <input id="auteur" type="text" value="${livre.getAut()}" name="auteur"> <!-- TODO : remplacer auteurDuLivre par l'auteur du livre -->
...
<!-- 
                ...
                -->
                 <c:forEach var="emprunt" items="${emprunts}">
				        <tr>
				            <td> ${emprunt.getMem().getPrenom()}, ${emprunt.getMem().getNom()} </td>
