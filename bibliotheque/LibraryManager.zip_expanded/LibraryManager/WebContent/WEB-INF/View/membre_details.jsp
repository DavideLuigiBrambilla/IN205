  ...
  <main>
    <section class="content">
      ...
      <h5>Détails du membre n° ${membre.getId()}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="membre_details?id=${membre.getId()}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	        ...
	        <div class="row">
	          <div class="input-field col s12">
	            <input id="adresse" type="text" value="${membre.getAddr()}" name="adresse"> <!-- TODO : remplacer adresseDuMembre par l'adresse du membre -->
	        ...
	        <div class="row">
	          ...
	          <div class="input-field col s6">
	            <input id="telephone" type="tel" value="${membre.getTel()}" name="telephone"> <!-- TODO : remplacer telephoneDuMembre par le téléphone du membre -->
	        ...
	        <table class="striped">
              ...
              <tbody id="results">
                ...
                <!-- 
                  ...
                  <td> " ${emprunt.getLiv().getTitre()} " ${emprunt.getLiv().getAut()} </td>
				  <td>${emprunt.getDateEmpr()}</td>
				  <c:choose>
						<c:when test="${emprunt.getDateRet()!=null}">
							<td>${emprunt.getDateRet()}</td>
						</c:when>    
						<c:otherwise>
							<td>
