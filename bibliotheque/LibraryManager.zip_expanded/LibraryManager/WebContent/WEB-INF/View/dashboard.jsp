          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><%if (request.getAttribute("nombremem") != null) {
                out.println("<p>" + request.getAttribute("nombremem") + "</p>");}%></h3> <!-- TODO : afficher le nombre de membres à la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><%if (request.getAttribute("nombreliv") != null) {
                out.println("<p>" + request.getAttribute("nombreliv") + "</p>");}%></h3> <!-- TODO : afficher le nombre de livres à la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><%if (request.getAttribute("nombreemp") != null) {
                out.println("<p>" + request.getAttribute("nombreemp") + "</p>");}%></h3></h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
